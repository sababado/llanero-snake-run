...
import { Loader2, Settings, BarChart3, Repeat } from 'lucide-react';
...
const GameOverMenu: React.FC<GameOverMenuProps> = ({
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-green-300 text-2xl font-bold mb-6 drop-shadow-md">{winnerText}</p>
            ...
            {/* Action Buttons */}
            <div className="flex gap-3 mt-8 w-full max-w-md justify-center">
                <button 
                    onClick={() => startGame(1)}
